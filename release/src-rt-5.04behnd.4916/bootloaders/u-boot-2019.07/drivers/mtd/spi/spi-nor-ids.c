...
const struct flash_info spi_nor_ids[] = {
	...
	{ INFO("bcmikos",	0x808080, 0, 64 * 1024, 64, SECT_4K) },
#endif	
	...
	/* XM25QH128D is die-identical to XM25QH128C and reports the same
	 * JEDEC ID (0x204018). Added for the 16MB SPI NOR on BCM6856.
	 */
