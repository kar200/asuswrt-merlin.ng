...
bus_drv_t *bus_drv_get(bus_type_t bus_type)
{
    ...
    case BUS_TYPE_6858_LPORT:
        ...
        break;
#endif
#if defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM6856) || defined(CONFIG_TARGET_BCM96856) || defined(CONFIG_BCM96878) || defined(CONFIG_BCM96855)   
