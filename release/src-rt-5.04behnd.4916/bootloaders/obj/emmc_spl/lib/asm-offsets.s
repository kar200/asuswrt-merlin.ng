...
// /build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c
// -mstrict-align -march=armv8-a -mlittle-endian -mabi=lp64
// -auxbase-strip lib/asm-offsets.s -g -Os -Os
...
main:
.LFB218:
	.file 1 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c"
	.loc 1 19 1 view -0
	.cfi_startproc
	.loc 1 21 2 view .LVU1
#APP
// 21 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GENERATED_GBL_DATA_SIZE 416 (sizeof(struct global_data) + 15) & ~15"	//
// 0 "" 2
	.loc 1 24 2 view .LVU2
// 24 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GENERATED_BD_INFO_SIZE 160 (sizeof(struct bd_info) + 15) & ~15"	//
// 0 "" 2
	.loc 1 27 2 view .LVU3
// 27 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GD_SIZE 408 sizeof(struct global_data)"	//
// 0 "" 2
	.loc 1 29 2 view .LVU4
// 29 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GD_BD 0 offsetof(struct global_data, bd)"	//
// 0 "" 2
	.loc 1 31 2 view .LVU5
// 31 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GD_MALLOC_BASE 272 offsetof(struct global_data, malloc_base)"	//
// 0 "" 2
	.loc 1 34 2 view .LVU6
// 34 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GD_RELOCADDR 112 offsetof(struct global_data, relocaddr)"	//
// 0 "" 2
	.loc 1 36 2 view .LVU7
// 36 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GD_RELOC_OFF 152 offsetof(struct global_data, reloc_off)"	//
// 0 "" 2
	.loc 1 38 2 view .LVU8
// 38 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GD_START_ADDR_SP 144 offsetof(struct global_data, start_addr_sp)"	//
// 0 "" 2
	.loc 1 40 2 view .LVU9
// 40 "/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c" 1
	
.ascii "->GD_NEW_GD 160 offsetof(struct global_data, new_gd)"	//
// 0 "" 2
	.loc 1 42 2 view .LVU10
// /build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c:43: }
...
.LASF5:
	.string	"unsigned int"
.LASF13:
	.string	"/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/u-boot-2019.07/lib/asm-offsets.c"
.LASF1:
...
.LASF14:
	.string	"/build/asuswrt-merlin/release/src-rt-5.04behnd.4916/bootloaders/obj/emmc_spl"
.LASF11:
	.string	"long double"
.LASF8:
	.string	"short int"
