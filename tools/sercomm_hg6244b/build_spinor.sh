#!/usr/bin/env bash
#
# Build Broadcom BCM6856 SPI-NOR U-Boot for Sercomm HG6244B.
#
set -euo pipefail
...
echo "============================================================"
echo " Building BCM6856 SPI-NOR Bootloader (${OPTIONS})"
...
echo '=== Step 5: Assemble Bootstrap Image (Loader + FIT @ 2MB) ==='
\$MK -j${JOBS} image_bootstrap_spinor
"

echo "[+] SPI-NOR build finished successfully."
echo "[*] Assembling and verifying deliverables..."
python3 "${SCRIPT_DIR}/assemble_and_verify.py" --target spinor
